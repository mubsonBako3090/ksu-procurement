                                                                                                                      ...
                                                                                                                      await connectDB();
                                                                                                                        ...
                                                                                                                        const req = await Requisition.findById(id);
                                                                                                                          if (!req) throw { statusCode: 404, message: 'Requisition not found' };
                                                                                                                            ...
                                                                                                                            if (req.requester.toString() !== user.id && user.role !== 'admin') {
                                                                                                                                throw { statusCode: 403, message: 'Not authorized to update this requisition' };
                                                                                                                                  }
                                                                                                                                                                        ...
                                                                                                                                                                        const req = await Requisition.findById(id)
                                                                                                                                                                            .populate('department');
                                                                                                                                                                              ...
                                                                                                                                                                              if (!req) throw { statusCode: 404, message: 'Requisition not found' };
                                                                                                                                                                                ...
                                                                                                                                                                                if (!['draft', 'rejected'].includes(req.status)) {
                                                                                                                                                                                    throw { statusCode: 400, message: 'Requisition already submitted' };
                                                                                                                                                                                      }
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  department: req.department._id,
                                                                                                                                                                                                      isActive:   true,
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          // Build approval chain
                                                                                                                                                                                                            const approvalChain = [
                                                                                                                                                                                                                { role: 'hod',         level: 0, status: 'pending', approver: hod?._id },
                                                                                                                                                                                                                    { role: 'procurement', level: 1, status: 'pending' },
                                                                                                                                                                                                                        { role: 'finance',     level: 2, status: 'pending' },
                                                                                                                                                                                                                            { role: 'vc',          level: 3, status: 'pending' },
                                                                                                                                                                                                                              ];
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    subject: `[Action Required] ${req.reqNumber} — Pending HOD Approval`,
                                                                                                                                                                                                                                                                                                          html: `
                                                                                                                                                                                                                                                                                                                  <div style="font-family:Sora,sans-serif;max-width:560px;margin:auto">
                                                                                                                                                                                                                                                                                                                            <h2 style="color:#00C37B">Approval Required</h2>
                                                                                                                                                                                                                                                                                                                                      <p>Dear ${hod.name},</p>
                                                                                                                                                                                                                                                                                                                                                <p>A new procurement requisition requires your approval:</p>
                                                                                                                                                                                                                                                                                                                                                          <table style="width:100%;border-collapse:collapse;margin:16px 0">
                                                                                                                                                                                                                                                                                                                                                                      <tr><td style="padding:8px;color:#999">REQ Number</td><td style="padding:8px;font-weight:700">${req.reqNumber}</td></tr>
                                                                                                                                                                                                                                                                                                                                                                                  <tr><td style="padding:8px;color:#999">Title</td><td style="padding:8px">${req.title}</td></tr>
                                                                                                                                                                                                                                                                                                                                                                                              <tr><td style="padding:8px;color:#999">Amount</td><td style="padding:8px;font-weight:700;color:#00C37B">₦${Number(req.totalAmount).toLocaleString()}</td></tr>
                                                                                                                                                                                                                                                                                                                                                                                                          <tr><td style="padding:8px;color:#999">Priority</td><td style="padding:8px;text-transform:capitalize">${req.priority}</td></tr>
                                                                                                                                                                                                                                                                                                                                                                                                                    </table>
                                                                                                                                                                                                                                                                                                                                                                                                                              <a href="${process.env.NEXT_PUBLIC_APP_URL}/requisitions/${req._id}"
                                                                                                                                                                                                                                                                                                                                                                                                                                           style="display:inline-block;background:#00C37B;color:#000;padding:12px 24px;border-radius:8px;font-weight:700;text-decoration:none">
                                                                                                                                                                                                                                                                                                                                                                                                                                                       Review Requisition
                                                                                                                                                                                                                                                                                                                                                                                                                                                                 </a>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                           <p style="color:#999;font-size:12px;margin-top:24px">KSU Procurement System — Kaduna State University</p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         `,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             });
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 await AuditLog.create({
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     requisition: req._id,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         user:        user.id,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             action:      'SUBMITTED',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 details:     'Submitted for HOD approval',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   });
